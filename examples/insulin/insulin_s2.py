...
class SIM(object):
    ...
    def sim(self, TT, X0, D, P, I, property_checker):
        ...
        while T_ <= Tf:
            T_, X_, D_ = euler_intg_plant(Ti, X0, D[0])
...
def euler_intg_plant(t, state, mode):
...
#     elif(-Gs + 295):
    ...
    if mode == 0:
        ...
        insulin_rate = 0.97751710655*0.3
    elif mode == 2:
        insulin_rate = 0.97751710655*0.7
    elif mode == 3:
        insulin_rate = 0.97751710655*1.2
    elif mode == 4:
        insulin_rate = 0.97751710655*1.5
    else:
        raise RuntimeError
