...
% CAUTION:
% At places
% cells refer both to the grid cells -> [cx cy cz ...]
% and also arbitrary cubes -> [xl xh; yl yh; zl zh ...]

function violating_paths = find_all_cell_paths_thresh(RA, N, x0, prop, MAX_VIO, opts)
% VERBOSE = opts.v;
PLT = opts.p;
...
for i = 1:size(C0,1)
    c0 = C0(i,:);
    S0.c = c0;
    S0.x = Grid.getCellRange(c0, RA.eps);
    S0.n = 0;
    % TODO
